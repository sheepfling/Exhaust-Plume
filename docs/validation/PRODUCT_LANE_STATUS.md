...
| --- | --- | --- | --- | --- |
| `planar-moc-primitives-v1` | No provider; standalone `exhaust_plume.models.moc` foundation | 15 scalar round trips, interior/centerline compatibility, and an 8-cell open underexpanded fan pass | No product comparison; free-boundary/compression closure, convergence, and external measurement mapping remain pending | Numerical planar characteristic diagnostics only; no public VIS/SIG/RAY/FPA claim |

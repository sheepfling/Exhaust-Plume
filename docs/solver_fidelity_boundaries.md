...
8-cell open underexpanded fan, attached and mild-overexpanded lip-compression
branches, local ambient-pressure tangent residual, and mesh topology checks
pass with finite residuals. This is numerical-foundation evidence, not a

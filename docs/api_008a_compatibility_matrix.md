...
| `exhaust_plume.api.prescribed` | `PrescribedSectionedTubeProvider` | retain existing fixture provider | no new provider ports here | PRV-001 ports it after conformance |

...
from exhaust_plume.validation.moc_euler_refinement import (  # noqa: E402
...
from exhaust_plume.validation.moc_euler_entropy_characteristic_field import (  # noqa: E402
...
from exhaust_plume.validation.moc_euler_entropy_characteristic_free_boundary import (  # noqa: E402
...
def _euler_ambient_physical_field_fixture(sample_count: int = 9) -> Any:
  ...
  base_turns = (0.005, 0.14, 0.20, 0.22, 0.22, 0.20, 0.18, 0.17, 0.081637491676426)
  points = [
    (
...
def _reflected_domain_remesh_probe(
  ...
  physical_seed_field: Any | None = None,
) -> dict[str, Any]:
  ...
  alternating_physical_field = None
  alternating_physical_field_measurement = None
  alternating_physical_field_error = None
  alternating_physical_field_chain_refinement = None
  alternating_physical_field_chain_refinement_error = None
  try:
    ...
    alternating_physical_field = solve_reflected_domain_alternating_physical_field(
      alternating_source,
      compression_amplitude_rad=0.05,
    )
    alternating_physical_field_measurement = (
      measure_moc_reflected_domain_alternating_physical_field(
        alternating_physical_field
      )
    )
  except (ArithmeticError, FloatingPointError, TypeError, ValueError) as error:
  ...
  try:
    ...
    global_euler_shock_boundary_measurement = (
      measure_moc_reflected_domain_global_euler_shock_boundary(
        global_euler_shock_boundary,
      )
    )
  ...
  ) = _alternating_physical_field_chain_refinement_probe(physical_seed_field)

  alternating_source_planner = None
  alternating_source_planner_error = None
  if (
    physical_seed_field is not None
    and getattr(physical_seed_field, 'converged', False)
    and alternating_source is not None
    ...
    try:
      alternating_source_planner = plan_reflected_domain_alternating_source_chain(
        physical_seed_field,
        alternating_source,
        start_x_m=0.5,
        end_x_m=2.0,
  ...
  accepted = bool(
    ...
    and alternating_physical_field is not None
    and alternating_physical_field.status is (
      MocReflectedDomainAlternatingPhysicalFieldStatus.CONVERGED_AMBIENT_CLOSED
    )
    and alternating_physical_field.converged
    and alternating_physical_field.physical_closure_verified
    and alternating_physical_field.state_sampling_available
    and alternating_physical_field.upstream_coupling_verified
    and alternating_physical_field.chain_promotion_blocked is False
    and alternating_physical_field.production_claim_allowed is False
    and alternating_physical_field_measurement is not None
    and alternating_physical_field_measurement.status is (
      MocReflectedDomainAlternatingPhysicalFieldMeasurementStatus.CONVERGED
    )
    and alternating_physical_field_measurement.bounded_physical_field_verified
    ...
    and global_euler_shock_boundary is not None
    and global_euler_shock_boundary.status is (
    ...
    and global_euler_shock_boundary_measurement is not None
    and global_euler_shock_boundary_measurement.status is (
    ...
    and alternating_physical_field_chain_refinement.resolution_metadata_verified
    and alternating_physical_field_chain_refinement.field_count_consistent
    and alternating_physical_field_chain_refinement.geometry_shape_verified
    and alternating_physical_field_chain_refinement.solver_configuration_consistent
    and alternating_physical_field_chain_refinement.source_geometry_freshness_verified
    and alternating_physical_field_chain_refinement.pressure_loss_verified
    and alternating_physical_field_chain_refinement.handoff_metadata_complete
    and alternating_physical_field_chain_refinement.handoff_links_verified is True
    and alternating_physical_field_chain_refinement.fresh_domain_verified
    and alternating_physical_field_chain_refinement.refinement_convergence_verified
    and alternating_physical_field_chain_refinement.physical_closure_verified is False
    and alternating_physical_field_chain_refinement.chain_promotion_blocked
    and alternating_physical_field_chain_refinement.production_claim_allowed is False
    and alternating_source_planner is not None
    and alternating_source_planner.production_claim_allowed is False
    and alternating_source_planner.chain.resolved
    and alternating_source_planner.chain.cell_count == 2
    and alternating_source_planner.chain.termination_reason is (
      MocChainTerminationReason.SOLVER_RETURNED_NO_NEXT_CELL
    )
    and alternating_source_planner.chain.physical_termination is False
    and alternating_source_planner.handoff_links_verified is True
    and alternating_source_planner.diagnostics['one_step_domain'] is True
  ...
  return {
    ...
    'solver_generated_alternating_physical_field': (
      None
      if alternating_physical_field is None
      else alternating_physical_field.as_report()
    ),
    'alternating_physical_field_independent_measurement': (
      None
      if alternating_physical_field_measurement is None
    ...
    'global_reflected_shock_remesh_global_euler_closure': (
      None
      if global_euler_shock_boundary is None
      else global_euler_shock_boundary.as_report()
    ),
    'global_reflected_shock_remesh_global_euler_closure_independent_measurement': (
      None
      if global_euler_shock_boundary_measurement is None
      else global_euler_shock_boundary_measurement.as_report()
    ),
    ...
    'alternating_physical_field_chain_refinement': (
      ...
      if alternating_physical_field_chain_refinement is None
        ...
        **alternating_physical_field_chain_refinement.as_report(),
        'declared_tolerances': {
    ...
    'alternating_source_planner': (
      None
      if alternating_source_planner is None
      else alternating_source_planner.as_report()
    ),
    'alternating_source_planner_error': alternating_source_planner_error,
...
def _ambient_shock_strip_probe(
  ...
  geometry_owned_first_cell_research_chain_refinement = None
  geometry_owned_first_cell_research_chain_refinement_error = None
  geometry_owned_first_cell_research_chain_refinement_accepted = False
  if (
    geometry_owned_first_cell_candidate_accepted
    ...
    try:
      ...
      geometry_owned_first_cell_research_chain_accepted = bool(
        ...
        and geometry_owned_first_cell_research_chain.cell_count == 3
        and geometry_owned_first_cell_research_chain.continued_cell_count == 2
  ...
  if geometry_owned_first_cell_candidate_accepted:
    ...
    try:
      for candidate_sample_count in (5, 9, 17):
        refinement_candidate = (
          geometry_owned_first_cell_candidate
          if candidate_sample_count == 9
          else geometry_owned_first_cell_candidate_refinement_results.get(
            candidate_sample_count
          )
        )
        if refinement_candidate is None or refinement_candidate.field is None:
          raise ValueError(
        ...
        if (
          ...
          primary_chain = geometry_owned_first_cell_research_chain
        else:
          primary_chain = plan_first_cell_geometry_owned_research_chain(
            refinement_candidate,
        ...
        chain_refinement_cases.append(
          MocFirstCellResearchChainRefinementCase(
            sample_count=candidate_sample_count,
            planner=primary_chain,
      ...
      refinement_report = refinement_measurement.as_report()
      geometry_owned_first_cell_research_chain_refinement_accepted = bool(
        refinement_measurement.status
        is MocFirstCellResearchChainRefinementMeasurementStatus.CONVERGED
        and refinement_measurement.converged
        and refinement_measurement.sample_counts == (5, 9, 17)
        and refinement_measurement.cell_count == 3
        and refinement_measurement.sample_count_order_verified
        and refinement_measurement.expected_sample_counts_verified
        and refinement_measurement.cell_count_consistent
        and refinement_measurement.planner_kind_consistent
        and refinement_measurement.termination_consistency_verified
        and refinement_measurement.geometry_shape_verified
        and refinement_measurement.deterministic_repeats_verified
        and refinement_measurement.handoff_links_verified is True
        and refinement_measurement.physical_closure_verified
        and refinement_measurement.fidelity_isolation_verified
        and refinement_measurement.refinement_convergence_verified
        and refinement_report['chain_promotion_blocked'] is True
        and refinement_report['production_claim_allowed'] is False
        and refinement_report['canonical_free_boundary_verified'] is False
        and refinement_report['canonical_euler_verified'] is False
        and refinement_report['external_validation_verified'] is False
      )
    except (ArithmeticError, FloatingPointError, TypeError, ValueError) as error:
  ...
  geometry_owned_first_cell_alternating_research_chain_refinement = None
  geometry_owned_first_cell_alternating_research_chain_refinement_error = None
  geometry_owned_first_cell_alternating_research_chain_refinement_accepted = False
  if (
    geometry_owned_first_cell_candidate_accepted
    and geometry_owned_first_cell_candidate is not None
  ):
    try:
      alternating_chain_start_x_m = shock_fit.boundary_states[0].point_m[0]
      geometry_owned_first_cell_alternating_research_chain = (
        plan_first_cell_geometry_owned_alternating_research_chain(
          geometry_owned_first_cell_candidate,
          start_x_m=alternating_chain_start_x_m,
          end_x_m=alternating_chain_start_x_m + 0.5,
      ...
      alternating_chain_planner = (
        geometry_owned_first_cell_alternating_research_chain.chain_planner
      )
      geometry_owned_first_cell_alternating_research_chain_accepted = bool(
        geometry_owned_first_cell_alternating_research_chain.planner_kind
        is MocChainPlannerKind.UPSTREAM_COUPLED_RESEARCH
        and geometry_owned_first_cell_alternating_research_chain.resolved
        and geometry_owned_first_cell_alternating_research_chain.cell_count == 3
        and geometry_owned_first_cell_alternating_research_chain.continued_cell_count == 2
        and geometry_owned_first_cell_alternating_research_chain.first_cell_handoff_verified
        and geometry_owned_first_cell_alternating_research_chain.continued_chain_audit_verified
        and geometry_owned_first_cell_alternating_research_chain.research_audit_accepted
        and geometry_owned_first_cell_alternating_research_chain.handoff_links_verified is True
        and geometry_owned_first_cell_alternating_research_chain.physical_closure_verified
        and geometry_owned_first_cell_alternating_research_chain.chain_promotion_blocked
        and geometry_owned_first_cell_alternating_research_chain.production_claim_allowed is False
        and geometry_owned_first_cell_alternating_research_chain.canonical_free_boundary_verified
        is False
        and geometry_owned_first_cell_alternating_research_chain.canonical_euler_verified
        is False
        and geometry_owned_first_cell_alternating_research_chain.external_validation_verified
        is False
        and geometry_owned_first_cell_alternating_research_chain.termination.reason
        is MocChainTerminationReason.SOLVER_RETURNED_NO_NEXT_CELL
        and geometry_owned_first_cell_alternating_research_chain.research_chain_measurement
        is not None
        and geometry_owned_first_cell_alternating_research_chain.research_chain_measurement.status
        is MocFirstCellResearchChainMeasurementStatus.CONVERGED
        and len(geometry_owned_first_cell_alternating_research_chain.physical_fields)
        == 3
        and alternating_chain_planner is not None
        and alternating_chain_planner.diagnostics.get(
  ...
  if geometry_owned_first_cell_candidate_accepted:
    ...
    try:
      for candidate_sample_count in (5, 9, 17):
        ...
        if (
          candidate_sample_count == 9
          and geometry_owned_first_cell_alternating_research_chain is not None
        ):
          primary_chain = geometry_owned_first_cell_alternating_research_chain
        else:
          primary_chain = plan_first_cell_geometry_owned_alternating_research_chain(
            refinement_candidate,
            start_x_m=refinement_start_x_m,
            end_x_m=refinement_start_x_m + 0.5,
            compression_amplitude_rad=0.01,
            total_cell_count=3,
            sample_count=candidate_sample_count,
            policy=MocChainContinuationPolicy(
        ...
        alternating_chain_refinement_cases.append(
          MocFirstCellResearchChainRefinementCase(
            sample_count=candidate_sample_count,
            planner=primary_chain,
            repeat_planner=repeat_chain,
      ...
      geometry_owned_first_cell_alternating_research_chain_refinement = (
        refinement_measurement
      )
      refinement_report = refinement_measurement.as_report()
      geometry_owned_first_cell_alternating_research_chain_refinement_accepted = bool(
        refinement_measurement.status
        is MocFirstCellResearchChainRefinementMeasurementStatus.CONVERGED
        and refinement_measurement.converged
        and refinement_measurement.sample_counts == (5, 9, 17)
        ...
        and refinement_report['canonical_euler_verified'] is False
        and refinement_report['external_validation_verified'] is False
        and len(alternating_chain_refinement_cases) == 3
        and all(
          case.planner.chain_planner is not None
          and case.repeat_planner.chain_planner is not None
          and case.planner.chain_planner.diagnostics.get(
            'alternating_physical_field_chain_audit_accepted'
          ) is True
          and case.repeat_planner.chain_planner.diagnostics.get(
            'alternating_physical_field_chain_audit_accepted'
          ) is True
          for case in alternating_chain_refinement_cases
        )
      )
    except (ArithmeticError, FloatingPointError, TypeError, ValueError) as error:
  ...
  reflected_domain_remesh = _reflected_domain_remesh_probe(
    ...
    physical_seed_field=ambient_centerline_physical_field.field,
  )
  ...
  return {
    ...
    'geometry_owned_first_cell_research_chain_refinement': (
      None
      if geometry_owned_first_cell_research_chain_refinement is None
      else geometry_owned_first_cell_research_chain_refinement.as_report()
    ),
    'geometry_owned_first_cell_research_chain_refinement_accepted': (
      geometry_owned_first_cell_research_chain_refinement_accepted
    ),
    'geometry_owned_first_cell_research_chain_refinement_error': (
      geometry_owned_first_cell_research_chain_refinement_error
    ...
    'geometry_owned_first_cell_alternating_research_chain': (
      None
      if geometry_owned_first_cell_alternating_research_chain is None
      else geometry_owned_first_cell_alternating_research_chain.as_report()
    ),
    'geometry_owned_first_cell_alternating_research_chain_accepted': (
      geometry_owned_first_cell_alternating_research_chain_accepted
    ),
    'geometry_owned_first_cell_alternating_research_chain_error': (
      geometry_owned_first_cell_alternating_research_chain_error
    ...
    'geometry_owned_first_cell_alternating_research_chain_refinement': (
      None
      if geometry_owned_first_cell_alternating_research_chain_refinement is None
      else geometry_owned_first_cell_alternating_research_chain_refinement.as_report()
    ),
    'geometry_owned_first_cell_alternating_research_chain_refinement_accepted': (
      geometry_owned_first_cell_alternating_research_chain_refinement_accepted
    ),
    'geometry_owned_first_cell_alternating_research_chain_refinement_error': (
      geometry_owned_first_cell_alternating_research_chain_refinement_error
...
def _mixed_regime_boundary_probe(
  ...
  # The production-generated terminal may carry a nonuniform upstream
  # pressure field whose outer oblique samples exceed the centerline normal
  # terminal pressure.  That is valid handoff evidence, but it is not legal
  # input to the scalar no-gain perimeter contract.  Keep this next reference
  # lane explicit with a derived pressure-lineage stress fixture rather than
  # silently changing the production-generated request.
  variable_entropy_patch = (
    MocPostShockBoundaryState(
      point_m=(terminal_x - 0.2, terminal_y + 0.2),
      state=CharacteristicState(
        x_m=terminal_x - 0.2,
        y_m=terminal_y + 0.2,
        theta_rad=0.1,
      ...
      upstream_total_pressure_Pa=0.99 * terminal.downstream_total_pressure_Pa,
      downstream_total_pressure_Pa=0.95 * terminal.downstream_total_pressure_Pa,
    ),
    MocPostShockBoundaryState(
      point_m=(terminal_x - 0.1, terminal_y + 0.1),
      state=CharacteristicState(
        x_m=terminal_x - 0.1,
        y_m=terminal_y + 0.1,
        theta_rad=0.05,
      ...
      upstream_total_pressure_Pa=0.98 * terminal.downstream_total_pressure_Pa,
      downstream_total_pressure_Pa=0.90 * terminal.downstream_total_pressure_Pa,
    ),
  )
  variable_entropy_request = replace(
    perimeter_request,
    supersonic_patch=variable_entropy_patch,
  )
  variable_entropy_handoff = variable_entropy_request.entropy_handoff()
  variable_entropy_fractions = (0.0, 1.0 / 3.0, 2.0 / 3.0, 1.0)
  variable_entropy_section_height_m = 0.05
  variable_entropy_section_x = terminal_x + 0.02
  variable_entropy_control_samples = tuple(
    MocMixedRegimeFieldSample(
      point_m=(
        variable_entropy_section_x,
        terminal_y + fraction * variable_entropy_section_height_m,
      ),
      mach=terminal.downstream_mach,
      flow_angle_rad=terminal.downstream_flow_angle_rad,
      static_pressure_Pa=(
        variable_entropy_handoff.total_pressure_at_arc_length(
          variable_entropy_handoff.cumulative_arc_length_m[-1]
          * (1.0 - fraction)
        )
        / (
          1.0
          + 0.5
          * (terminal.upstream_state.gamma - 1.0)
          * terminal.downstream_mach**2
        ) ** (
          terminal.upstream_state.gamma
          / (terminal.upstream_state.gamma - 1.0)
        )
      ),
      total_pressure_Pa=variable_entropy_handoff.total_pressure_at_arc_length(
        variable_entropy_handoff.cumulative_arc_length_m[-1]
        * (1.0 - fraction)
      ),
      gamma=terminal.upstream_state.gamma,
    )
    for fraction in variable_entropy_fractions
  )
  variable_entropy_control_section = MocMixedRegimeControlSection(
    points_m=tuple(sample.point_m for sample in variable_entropy_control_samples),
    samples=variable_entropy_control_samples,
    normal_angle_rad=0.0,
  )
  variable_entropy_reference = solve_mixed_regime_variable_entropy_free_boundary(
    variable_entropy_request,
    variable_entropy_handoff,
    variable_entropy_control_section,
    ambient_pressure_Pa=(
      0.98 * variable_entropy_handoff.samples[0].downstream_total_pressure_Pa
    ),
  ...
  return {
    ...
    'accepted': (
      ...
      and variable_entropy_reference.status is (
        MocMixedRegimeVariableEntropyFreeBoundaryStatus.CONVERGED_REFERENCE
      )
      and variable_entropy_reference.converged
      and variable_entropy_reference.source_streamline_mapping_verified
      and variable_entropy_reference.entropy_transport_verified
      and variable_entropy_reference.continuity_verified
      and variable_entropy_reference.free_boundary_condition_verified
      and variable_entropy_reference.field_topology_verified
      and variable_entropy_reference.physical_closure_verified is False
      and variable_entropy_reference.canonical_free_boundary_verified is False
      and variable_entropy_reference.canonical_euler_verified is False
      and variable_entropy_reference.chain_promotion_blocked
      and variable_entropy_reference.production_claim_allowed is False
      and variable_entropy_measurement.status is (
        MocMixedRegimeVariableEntropyFreeBoundaryMeasurementStatus.CONVERGED
      )
      and variable_entropy_measurement.converged
      and variable_entropy_measurement.reference_verified
      and variable_entropy_measurement.physical_closure_verified is False
      and variable_entropy_measurement.canonical_euler_verified is False
      and variable_entropy_measurement.chain_promotion_blocked
      and variable_entropy_measurement.production_claim_allowed is False
    ...
    'mixed_regime_variable_entropy_reference_request': (
      variable_entropy_request.as_report()
    ),
    'mixed_regime_variable_entropy_reference_control_section': (
      variable_entropy_control_section.as_report()
    ),
    'mixed_regime_variable_entropy_reference': (
      variable_entropy_reference.as_report()
    ),
    'mixed_regime_variable_entropy_reference_measurement': (
...
def _alternating_physical_field_chain_refinement_probe(
  ...
  """Measure fresh alternating physical-field chains at two resolutions.

  The source strip and centerline patch are rebuilt from each accepted field
  before every continued cell.  The resulting refinement evidence is kept
  below the canonical reflected free-boundary gate; it only demonstrates that
  the bounded research continuation is numerically repeatable.
  """
    ...
    for sample_count in (17, 33):
      ...
      for _cell_index in range(2):
        ...
        incoming_handoff = tuple(
          MocChainBoundarySample(state=state, total_pressure_Pa=pressure)
          for state, pressure in zip(
            current.centerline_boundary_states,
            current.centerline_boundary_total_pressure_Pa,
            strict=True,
          )
        )
...
def build_moc_primitive_report() -> dict[str, Any]:
  ...
  mixed_regime_variable_entropy_reference = mixed_regime_boundary_probe.get(
    'mixed_regime_variable_entropy_reference',
  )
  mixed_regime_variable_entropy_reference_measurement = (
  ...
  mixed_regime_variable_entropy_reference_failure = (
    not isinstance(mixed_regime_variable_entropy_reference, dict)
    or mixed_regime_variable_entropy_reference.get('status') != (
      MocMixedRegimeVariableEntropyFreeBoundaryStatus.CONVERGED_REFERENCE.value
    )
    or mixed_regime_variable_entropy_reference.get('converged') is not True
    or mixed_regime_variable_entropy_reference.get(
      'source_streamline_mapping_verified'
    ) is not True
    or mixed_regime_variable_entropy_reference.get('entropy_transport_verified') is not True
    or mixed_regime_variable_entropy_reference.get('continuity_verified') is not True
    or mixed_regime_variable_entropy_reference.get('free_boundary_condition_verified') is not True
    or mixed_regime_variable_entropy_reference.get('field_topology_verified') is not True
    or mixed_regime_variable_entropy_reference.get('physical_closure_verified') is not False
    or mixed_regime_variable_entropy_reference.get('canonical_free_boundary_verified') is not False
    or mixed_regime_variable_entropy_reference.get('canonical_euler_verified') is not False
    or mixed_regime_variable_entropy_reference.get('chain_promotion_blocked') is not True
    or mixed_regime_variable_entropy_reference.get('production_claim_allowed') is not False
    or not isinstance(mixed_regime_variable_entropy_reference_measurement, dict)
    or mixed_regime_variable_entropy_reference_measurement.get('status') != (
      MocMixedRegimeVariableEntropyFreeBoundaryMeasurementStatus.CONVERGED.value
    )
    or mixed_regime_variable_entropy_reference_measurement.get('converged') is not True
    or mixed_regime_variable_entropy_reference_measurement.get('reference_verified') is not True
    or mixed_regime_variable_entropy_reference_measurement.get('physical_closure_verified') is not False
    or mixed_regime_variable_entropy_reference_measurement.get('canonical_euler_verified') is not False
    or mixed_regime_variable_entropy_reference_measurement.get('chain_promotion_blocked') is not True
    or mixed_regime_variable_entropy_reference_measurement.get('production_claim_allowed') is not False
  )
  mixed_regime_boundary_failure = bool(
    mixed_regime_boundary_failure
    or mixed_regime_variable_entropy_reference_failure
  )
  ...
  geometry_owned_first_cell_research_chain_refinement_failure = (
    ambient_shock_strip_probe.get('accepted') is True
    and ambient_shock_strip_probe.get(
      'geometry_owned_first_cell_research_chain_refinement_accepted'
    ) is not True
  )
  geometry_owned_first_cell_alternating_research_chain_failure = (
    ambient_shock_strip_probe.get('accepted') is True
    and ambient_shock_strip_probe.get(
      'geometry_owned_first_cell_alternating_research_chain_accepted'
    ) is not True
  )
  geometry_owned_first_cell_alternating_research_chain_refinement_failure = (
    ambient_shock_strip_probe.get('accepted') is True
    and ambient_shock_strip_probe.get(
      'geometry_owned_first_cell_alternating_research_chain_refinement_accepted'
    ) is not True
  ...
  reflected_domain_alternating_physical_field_failure = (
    ambient_shock_strip_probe.get('accepted') is True
    and (
      not isinstance(reflected_domain_remesh_probe, dict)
      or not isinstance(
      ...
      != MocReflectedDomainAlternatingPhysicalFieldStatus.CONVERGED_AMBIENT_CLOSED.value
      or not isinstance(
        reflected_domain_remesh_probe.get(
          'alternating_physical_field_independent_measurement'
        ),
      ...
      != MocReflectedDomainAlternatingPhysicalFieldMeasurementStatus.CONVERGED.value
      or reflected_domain_remesh_probe[
        'alternating_physical_field_independent_measurement'
      ].get('checks', {}).get('bounded_physical_field_verified') is not True
      or not isinstance(
        reflected_domain_remesh_probe.get('alternating_source_planner'),
        dict,
      )
      or reflected_domain_remesh_probe['alternating_source_planner'].get(
        'chain', {}
      ).get('cell_count') != 2
      or reflected_domain_remesh_probe['alternating_source_planner'].get(
  ...
  reflected_domain_alternating_physical_field_chain_refinement_failure = (
    ...
    and (
      ...
      or reflected_domain_remesh_probe[
        'alternating_physical_field_chain_refinement'
      ].get('status') != 'converged'
      or reflected_domain_remesh_probe[
        'alternating_physical_field_chain_refinement'
      ].get('converged') is not True
      or not isinstance(
        reflected_domain_remesh_probe[
          'alternating_physical_field_chain_refinement'
        ].get('checks'),
        dict,
      )
      or not all(
        value is True
        for value in reflected_domain_remesh_probe[
          'alternating_physical_field_chain_refinement'
        ]['checks'].values()
      ...
      or reflected_domain_remesh_probe[
        'alternating_physical_field_chain_refinement'
      ].get('chain_promotion_blocked') is not True
      or reflected_domain_remesh_probe[
        'alternating_physical_field_chain_refinement'
      ].get('production_claim_allowed') is not False
    )
  )
  ...
  euler_explicit_companion_ambient_shock_field = (
    assemble_euler_ambient_shock_field_from_companion(
      euler_consistent_shock_boundary,
      euler_ambient_companion_boundary,
    )
  )
  euler_explicit_companion_ambient_shock_field_audit = (
    measure_moc_euler_ambient_shock_field(
      euler_explicit_companion_ambient_shock_field,
    )
  )
  euler_explicit_companion_ambient_shock_field_chain_mock = (
    plan_euler_ambient_shock_field_chain_mock(
      euler_explicit_companion_ambient_shock_field,
      mock=MocEulerAmbientShockFieldChainMock(
        total_field_count=3,
  ...
  euler_explicit_companion_ambient_shock_field_chain_mock_measurement = (
    measure_moc_euler_ambient_shock_field_chain(
      euler_explicit_companion_ambient_shock_field_chain_mock,
    )
  )
  euler_post_shock_field = assemble_euler_post_shock_field(
    euler_consistent_shock_boundary,
  )
  euler_post_shock_field_audit = measure_moc_euler_post_shock_field(
    euler_post_shock_field,
  )
  euler_post_shock_field_chain_mock = plan_euler_post_shock_field_chain_mock(
    euler_post_shock_field,
    mock=MocEulerPostShockFieldChainMock(
      total_field_count=3,
      axial_translation_m=2.0,
    ),
  )
  euler_post_shock_field_chain_mock_measurement = (
    measure_moc_euler_post_shock_field_chain(
    ...
    measure_moc_euler_ambient_physical_field_refinement(
      tuple(
        MocEulerAmbientPhysicalFieldRefinementCase(
          ...
          result=(
            assemble_euler_ambient_physical_field(
              shock := _euler_ambient_physical_field_fixture(resolution),
  ...
  euler_ambient_first_wedge_characteristic_field_planner = (
    plan_euler_ambient_first_wedge_characteristic_field(
      euler_ambient_physical_field,
    )
  )
  euler_ambient_first_wedge_characteristic_field_audit = (
    None
    if euler_ambient_first_wedge_characteristic_field_planner.field_retile is None
    else measure_moc_euler_ambient_first_wedge_characteristic_field_audit(
  ...
  euler_ambient_first_wedge_entropy_characteristic_field_planner = (
    ...
    if euler_ambient_first_wedge_entropy_carry_planner is None
    or euler_ambient_first_wedge_entropy_carry_planner.entropy_carry is None
    else plan_euler_ambient_first_wedge_entropy_characteristic_field(
      euler_ambient_first_wedge_entropy_carry_planner.entropy_carry,
    )
  )
  euler_ambient_first_wedge_entropy_characteristic_field_audit = (
    None
    ...
    else measure_moc_euler_ambient_first_wedge_entropy_characteristic_field(
      euler_ambient_first_wedge_entropy_characteristic_field_planner.field,
    )
  )
  euler_ambient_first_wedge_entropy_characteristic_field_chain_mock = (
    MocEulerAmbientFirstWedgeEntropyCharacteristicFieldChainMock()
  )
  euler_ambient_first_wedge_entropy_characteristic_field_chain_planner = (
    ...
    if euler_ambient_first_wedge_entropy_characteristic_field_planner is None
    or euler_ambient_first_wedge_entropy_characteristic_field_planner.field is None
    else plan_euler_ambient_first_wedge_entropy_characteristic_field_chain_mock(
      euler_ambient_first_wedge_entropy_characteristic_field_planner.field,
      mock=euler_ambient_first_wedge_entropy_characteristic_field_chain_mock,
    )
  )
  euler_ambient_first_wedge_entropy_characteristic_field_chain_audit = (
    None
    if euler_ambient_first_wedge_entropy_characteristic_field_chain_planner is None
    else measure_moc_euler_ambient_first_wedge_entropy_characteristic_field_chain(
      euler_ambient_first_wedge_entropy_characteristic_field_chain_planner,
    )
  )
  ...
  entropy_characteristic_field = (
    None
    if euler_ambient_first_wedge_entropy_characteristic_field_planner is None
    else euler_ambient_first_wedge_entropy_characteristic_field_planner.field
  )
  entropy_characteristic_handoff = (
    None
    if entropy_characteristic_field is None
    else entropy_characteristic_field.continuation_boundary
  )
  entropy_characteristic_free_boundary_start = (
    None
    if not entropy_characteristic_handoff
    else entropy_characteristic_handoff[0]
  )
  entropy_characteristic_free_boundary_ambient_pressure = (
    None
    if entropy_characteristic_field is None
    or entropy_characteristic_free_boundary_start is None
    else entropy_characteristic_field.static_pressure_at(
      entropy_characteristic_free_boundary_start.point_m,
      position_tolerance_m=1.0e-8,
    )
  )
  euler_ambient_first_wedge_entropy_characteristic_free_boundary = (
    None
    if entropy_characteristic_field is None
    or not entropy_characteristic_handoff
    or entropy_characteristic_free_boundary_start is None
    or entropy_characteristic_free_boundary_ambient_pressure is None
    else solve_euler_ambient_first_wedge_entropy_characteristic_free_boundary(
      entropy_characteristic_field,
      entropy_characteristic_handoff,
      entropy_characteristic_free_boundary_start.point_m,
      entropy_characteristic_free_boundary_ambient_pressure,
  ...
  euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner = (
    None
    if entropy_characteristic_field is None
    or entropy_characteristic_free_boundary_ambient_pressure is None
    else plan_euler_ambient_first_wedge_entropy_characteristic_free_boundary_probe(
      entropy_characteristic_field,
  ...
  euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit = (
    None
    if euler_ambient_first_wedge_entropy_characteristic_free_boundary is None
    else measure_moc_euler_ambient_first_wedge_entropy_characteristic_free_boundary(
      euler_ambient_first_wedge_entropy_characteristic_free_boundary,
      position_tolerance_m=1.0e-8,
    )
  )
  euler_ambient_first_wedge_entropy_characteristic_continuation = (
    ...
    or not entropy_characteristic_handoff
    or entropy_characteristic_free_boundary_ambient_pressure is None
    else solve_euler_ambient_first_wedge_entropy_characteristic_continuation(
      entropy_characteristic_field,
      entropy_characteristic_handoff,
      entropy_characteristic_free_boundary_ambient_pressure,
      cycle_count=4,
  ...
  euler_ambient_first_wedge_entropy_characteristic_continuation_planner = (
    None
    if entropy_characteristic_field is None
    or entropy_characteristic_free_boundary_ambient_pressure is None
    else plan_euler_ambient_first_wedge_entropy_characteristic_continuation_probe(
      entropy_characteristic_field,
      ambient_pressure_Pa=entropy_characteristic_free_boundary_ambient_pressure,
      cycle_count=4,
      position_tolerance_m=1.0e-8,
  ...
  euler_ambient_first_wedge_entropy_characteristic_continuation_audit = (
    None
    if euler_ambient_first_wedge_entropy_characteristic_continuation is None
    else measure_moc_euler_ambient_first_wedge_entropy_characteristic_continuation(
      euler_ambient_first_wedge_entropy_characteristic_continuation,
      position_tolerance_m=1.0e-8,
    )
  )
  euler_ambient_first_wedge_entropy_characteristic_continuation_chain = (
    None
    if entropy_characteristic_field is None
    or entropy_characteristic_free_boundary_ambient_pressure is None
    else plan_euler_ambient_first_wedge_entropy_characteristic_continuation_chain_reference(
      entropy_characteristic_field,
      ambient_pressure_Pa=entropy_characteristic_free_boundary_ambient_pressure,
  ...
  euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit = (
    None
    if euler_ambient_first_wedge_entropy_characteristic_continuation_chain is None
    else measure_moc_euler_ambient_first_wedge_entropy_characteristic_continuation_chain(
      euler_ambient_first_wedge_entropy_characteristic_continuation_chain,
      position_tolerance_m=1.0e-8,
    )
  )
  ...
  euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner = (
    None
    if entropy_characteristic_field is None
    or entropy_characteristic_free_boundary_ambient_pressure is None
    else plan_euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_probe(
      entropy_characteristic_field,
      ambient_pressure_Pa=entropy_characteristic_free_boundary_ambient_pressure,
      cycle_count=4,
  ...
  geometry_results = {
    ...
    'euler_ambient_shock_field_explicit_companion': {
      'ambient_pressure_Pa': euler_ambient_pressure,
      'field_candidate': euler_explicit_companion_ambient_shock_field.as_report(),
      'independent_audit': (
        euler_explicit_companion_ambient_shock_field_audit.as_report()
      ),
      'open_field_chain_mock': {
        **euler_explicit_companion_ambient_shock_field_chain_mock.as_report(),
        'independent_audit': (
          euler_explicit_companion_ambient_shock_field_chain_mock_measurement.as_report()
        ),
      },
      'claim_status': (
        'exact-open-separated-companion-field-and-continued-chain-mock; '
        'shared-attachment-remeshing, entropy transport, reflected closure, '
        'and physical chain-cell promotion pending'
      ),
    },
    'euler_post_shock_field_local_closed_topology': {
      'field_candidate': euler_post_shock_field.as_report(),
      'independent_audit': euler_post_shock_field_audit.as_report(),
      'open_field_chain_mock': {
        **euler_post_shock_field_chain_mock.as_report(),
        'independent_audit': (
          euler_post_shock_field_chain_mock_measurement.as_report()
        ),
      },
      'claim_status': (
    ...
    'euler_ambient_first_wedge_characteristic_field': {
      'planner': (
        euler_ambient_first_wedge_characteristic_field_planner.as_report()
      ),
      'independent_audit': (
        None
        if euler_ambient_first_wedge_characteristic_field_audit is None
        else euler_ambient_first_wedge_characteristic_field_audit.as_report()
      ),
      'claim_status': (
    ...
    'euler_ambient_first_wedge_entropy_characteristic_field': {
      'planner': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_field_planner is None
        else euler_ambient_first_wedge_entropy_characteristic_field_planner.as_report()
      ),
      'independent_audit': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_field_audit is None
        else euler_ambient_first_wedge_entropy_characteristic_field_audit.as_report()
      ),
      'claim_status': (
        ...
        'shock-cell-chain promotion pending'
      ),
    },
    'euler_ambient_first_wedge_entropy_characteristic_field_chain': {
      'mock': euler_ambient_first_wedge_entropy_characteristic_field_chain_mock.as_report(),
      'planner': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_field_chain_planner is None
        else euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.as_report()
      ),
      'independent_audit': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_field_chain_audit is None
        else euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.as_report()
      ),
      'claim_status': (
    ...
    'euler_ambient_first_wedge_entropy_characteristic_free_boundary': {
      'free_boundary': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_free_boundary is None
        else euler_ambient_first_wedge_entropy_characteristic_free_boundary.as_report()
      ),
      'planner_probe': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner is None
        else euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.as_report()
      ),
      'independent_audit': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit is None
        else euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.as_report()
      ),
      'claim_status': (
        'solver-generated-bounded-entropy-characteristic-reflected-free-'
        'boundary probe; field boundary, independent refinement, external '
        'validation, and physical shock-cell promotion remain explicit gates'
      ),
    },
    'euler_ambient_first_wedge_entropy_characteristic_continuation': {
      'continuation': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_continuation is None
        else euler_ambient_first_wedge_entropy_characteristic_continuation.as_report()
      ),
      'planner_probe': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_continuation_planner is None
        else euler_ambient_first_wedge_entropy_characteristic_continuation_planner.as_report()
      ),
      'independent_audit': (
        None
      ...
      'continuation_chain': (
        None
        if euler_ambient_first_wedge_entropy_characteristic_continuation_chain is None
        else euler_ambient_first_wedge_entropy_characteristic_continuation_chain.as_report()
      ),
      'continuation_chain_independent_audit': (
        None
      ...
      'characteristic_remesh': [
        remesh.as_report()
        for remesh in (
          euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_results
        )
      ],
      'characteristic_remesh_audits': [
        audit.as_report()
        for audit in (
          euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_audits
        )
      ],
      'characteristic_remesh_planner_probe': (
        None
      ...
      'claim_status': (
        ...
        'projection refinement and characteristic-edge remesh evidence are '
        'diagnostic only; interior re-closure, reflected-shock closure, external validation, and '
  ...
  euler_explicit_companion_ambient_shock_field_failure = (
    euler_explicit_companion_ambient_shock_field.status
    is not MocEulerAmbientShockFieldStatus.CONVERGED_OPEN
    or not euler_explicit_companion_ambient_shock_field.converged
    or euler_explicit_companion_ambient_shock_field.ambient_march is not None
    or euler_explicit_companion_ambient_shock_field.ambient_companion_boundary
    is not euler_ambient_companion_boundary
    or euler_explicit_companion_ambient_shock_field_audit.status
    is not MocEulerAmbientShockFieldAuditStatus.CONVERGED_LOCAL_AUDIT
    or not euler_explicit_companion_ambient_shock_field_audit.converged
    or euler_explicit_companion_ambient_shock_field_audit.ambient_boundary_kind
    != 'explicit-separated-companion'
    or not euler_explicit_companion_ambient_shock_field_audit.ambient_boundary_verified
    or not euler_explicit_companion_ambient_shock_field_audit.companion_field_verified
    or not euler_explicit_companion_ambient_shock_field_audit.promotion_flags_verified
  )
  euler_explicit_companion_ambient_shock_field_chain_mock_failure = (
    euler_explicit_companion_ambient_shock_field_chain_mock.planner_kind
    is not MocChainPlannerKind.UPSTREAM_COUPLED_RESEARCH
    or not euler_explicit_companion_ambient_shock_field_chain_mock.resolved
    or euler_explicit_companion_ambient_shock_field_chain_mock.field_count != 3
    or euler_explicit_companion_ambient_shock_field_chain_mock.continued_field_count != 2
    or euler_explicit_companion_ambient_shock_field_chain_mock.handoff_links_verified is not True
    or euler_explicit_companion_ambient_shock_field_chain_mock.termination.reason
    is not MocChainTerminationReason.SOLVER_RETURNED_NO_NEXT_CELL
    or euler_explicit_companion_ambient_shock_field_chain_mock.physical_closure_verified
    or not euler_explicit_companion_ambient_shock_field_chain_mock.chain_promotion_blocked
    or euler_explicit_companion_ambient_shock_field_chain_mock.production_claim_allowed
    or euler_explicit_companion_ambient_shock_field_chain_mock_measurement.status
    is not MocEulerAmbientShockFieldChainAuditStatus.CONVERGED_LOCAL_AUDIT
    or not euler_explicit_companion_ambient_shock_field_chain_mock_measurement.converged
    or not euler_explicit_companion_ambient_shock_field_chain_mock_measurement.field_audits_verified
    or not euler_explicit_companion_ambient_shock_field_chain_mock_measurement.local_sequence_verified
    or euler_explicit_companion_ambient_shock_field_chain_mock_measurement.physical_closure_verified
    or not euler_explicit_companion_ambient_shock_field_chain_mock_measurement.chain_promotion_blocked
    or euler_explicit_companion_ambient_shock_field_chain_mock_measurement.production_claim_allowed
  )
  euler_post_shock_field_failure = (
    euler_post_shock_field.status is not MocEulerPostShockFieldStatus.CONVERGED_LOCAL_CLOSED
    or not euler_post_shock_field.converged
    or not euler_post_shock_field.closed_topology_verified
    or not euler_post_shock_field.state_sampling_available
    or euler_post_shock_field.physical_closure_verified
    or not euler_post_shock_field.chain_promotion_blocked
    or euler_post_shock_field.production_claim_allowed
    or euler_post_shock_field_audit.status is not MocEulerPostShockFieldAuditStatus.CONVERGED_LOCAL_AUDIT
    or not euler_post_shock_field_audit.local_consistency_verified
  )
  euler_post_shock_field_chain_mock_failure = (
    euler_post_shock_field_chain_mock.planner_kind is not MocChainPlannerKind.UPSTREAM_COUPLED_RESEARCH
    or not euler_post_shock_field_chain_mock.resolved
    or euler_post_shock_field_chain_mock.field_count != 3
    or euler_post_shock_field_chain_mock.continued_field_count != 2
    or euler_post_shock_field_chain_mock.handoff_links_verified is not True
    or euler_post_shock_field_chain_mock.termination.reason is not MocChainTerminationReason.SOLVER_RETURNED_NO_NEXT_CELL
    or euler_post_shock_field_chain_mock.physical_closure_verified
    or not euler_post_shock_field_chain_mock.chain_promotion_blocked
    or euler_post_shock_field_chain_mock.production_claim_allowed
  ...
  euler_ambient_physical_field_refinement_failure = (
    euler_ambient_physical_field_refinement.status
    is not MocEulerAmbientPhysicalFieldRefinementStatus.FIRST_WEDGE_REFINEMENT_FAILURE
    or euler_ambient_physical_field_refinement.converged
    or not euler_ambient_physical_field_refinement.resolution_order_verified
    or not euler_ambient_physical_field_refinement.candidate_fields_verified
    or not euler_ambient_physical_field_refinement.shock_jumps_verified
    or euler_ambient_physical_field_refinement.first_wedge_cell_counts
    != (1, 1, 1)
    or euler_ambient_physical_field_refinement.first_wedge_subdivision_verified
    or euler_ambient_physical_field_refinement.refinement_convergence_verified
  ...
  euler_ambient_first_wedge_characteristic_field_failure = (
    euler_ambient_first_wedge_characteristic_field_audit is None
    or euler_ambient_first_wedge_characteristic_field_audit.status
    is not MocEulerAmbientFirstWedgeCharacteristicFieldAuditStatus.ENTROPY_FAILURE
    or not euler_ambient_first_wedge_characteristic_field_audit.topology_verified
    or not euler_ambient_first_wedge_characteristic_field_audit.boundary_paths_verified
    or not euler_ambient_first_wedge_characteristic_field_audit.state_samples_finite
    or not euler_ambient_first_wedge_characteristic_field_audit.cell_euler_residuals_finite
    or euler_ambient_first_wedge_characteristic_field_audit.cell_euler_residuals_verified
    or not euler_ambient_first_wedge_characteristic_field_audit.retiled_field_status_barrier_verified
    or not euler_ambient_first_wedge_characteristic_field_audit.solver_status_consistent
    or euler_ambient_first_wedge_characteristic_field_audit.physical_closure_verified
    or not euler_ambient_first_wedge_characteristic_field_audit.chain_promotion_blocked
    or euler_ambient_first_wedge_characteristic_field_audit.production_claim_allowed
    or not euler_ambient_first_wedge_characteristic_field_planner.resolved
    or euler_ambient_first_wedge_characteristic_field_planner.termination.reason
    is not MocChainTerminationReason.FIDELITY_NOT_ALLOWED
  ...
  euler_ambient_first_wedge_entropy_characteristic_field_failure = (
    euler_ambient_first_wedge_entropy_characteristic_field_planner is None
    or not euler_ambient_first_wedge_entropy_characteristic_field_planner.resolved
    or euler_ambient_first_wedge_entropy_characteristic_field_planner.termination.reason
    is not MocChainTerminationReason.FIDELITY_NOT_ALLOWED
    or euler_ambient_first_wedge_entropy_characteristic_field_planner.physical_chain_cell_count
    != 0
    or euler_ambient_first_wedge_entropy_characteristic_field_audit is None
    or euler_ambient_first_wedge_entropy_characteristic_field_audit.status
    is not MocEulerAmbientFirstWedgeEntropyCharacteristicFieldAuditStatus.CONVERGED_LOCAL_AUDIT
    or not euler_ambient_first_wedge_entropy_characteristic_field_audit.local_consistency_verified
    ...
    or not euler_ambient_first_wedge_entropy_characteristic_field_audit.cell_euler_residuals_finite
    or not euler_ambient_first_wedge_entropy_characteristic_field_audit.cell_euler_residuals_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_audit.internal_characteristic_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_audit.solver_status_consistent
    or euler_ambient_first_wedge_entropy_characteristic_field_audit.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_audit.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_field_audit.production_claim_allowed
  )
  euler_ambient_first_wedge_entropy_characteristic_field_chain_failure = (
    euler_ambient_first_wedge_entropy_characteristic_field_chain_planner is None
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.resolved
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.local_sequence_verified
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.field_count != 1
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.continued_field_count != 0
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.termination.reason
    is not MocChainTerminationReason.SOLVER_RETURNED_NO_NEXT_CELL
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.physical_chain_cell_count
    != 0
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_planner.production_claim_allowed
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_audit is None
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.status
    is not MocEulerAmbientFirstWedgeEntropyCharacteristicFieldChainAuditStatus.CONVERGED_LOCAL_CHAIN_AUDIT
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.local_consistency_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.handoff_links_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.fresh_domains_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.termination_verified
    or not euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.planner_resolved_consistent
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.physical_chain_cell_count != 0
    or euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.physical_closure_verified
  ...
  euler_ambient_first_wedge_entropy_characteristic_free_boundary_failure = (
    euler_ambient_first_wedge_entropy_characteristic_free_boundary is None
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.status
    is not MocEulerAmbientFirstWedgeEntropyCharacteristicFreeBoundaryStatus.UPSTREAM_FIELD_BOUNDARY
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.shock is None
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.shock.status
    is not MocFreeBoundaryShockStatus.UPSTREAM_FIELD_FAILURE
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.shock_sample_count
    != 1
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.covered_sample_count
    != 1
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.first_missing_sample_index
    != 1
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.path_coverage_verified
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.reflected_free_boundary_verified
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary.production_claim_allowed
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner is None
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.field_count != 1
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.continued_field_count != 0
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.termination.reason
    is not MocChainTerminationReason.UPSTREAM_FIELD_BOUNDARY
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.termination.physical_termination
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.physical_chain_cell_count
    != 0
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.production_claim_allowed
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_planner.diagnostics.get(
    ...
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit is None
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.status
    is not MocEulerAmbientFirstWedgeEntropyCharacteristicFreeBoundaryAuditStatus.CONVERGED_LOCAL_BOUNDARY_AUDIT
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.local_consistency_verified
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.incoming_handoff_verified
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.path_coverage_verified
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.status_consistent
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.external_validation_required
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.fidelity_flags_verified
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.covered_sample_count
    != 1
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.first_missing_sample_index
    != 1
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.production_claim_allowed
  )
  euler_ambient_first_wedge_entropy_characteristic_continuation_failure = (
    euler_ambient_first_wedge_entropy_characteristic_continuation is None
    or euler_ambient_first_wedge_entropy_characteristic_continuation.status
    is not MocEulerAmbientFirstWedgeEntropyCharacteristicContinuationStatus.CONVERGED_BOUNDED_CONTINUATION
    or not euler_ambient_first_wedge_entropy_characteristic_continuation.converged
    or not euler_ambient_first_wedge_entropy_characteristic_continuation.local_consistency_verified
    or euler_ambient_first_wedge_entropy_characteristic_continuation.cycle_count != 4
    or len(euler_ambient_first_wedge_entropy_characteristic_continuation.centerline_states) != 4
    or len(euler_ambient_first_wedge_entropy_characteristic_continuation.outer_states) != 4
    or len(euler_ambient_first_wedge_entropy_characteristic_continuation.cells) != 7
    or not euler_ambient_first_wedge_entropy_characteristic_continuation.continuation_boundary_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation.cell_euler_residuals_finite
    or euler_ambient_first_wedge_entropy_characteristic_continuation.cell_euler_residuals_verified
    or euler_ambient_first_wedge_entropy_characteristic_continuation.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_continuation.production_claim_allowed
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner is None
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.field_count != 1
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.continued_field_count != 0
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.termination.reason
    is not MocChainTerminationReason.OPEN_PHYSICAL_CLOSURE
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.termination.physical_termination
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.physical_chain_cell_count != 0
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_planner.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.production_claim_allowed
    or euler_ambient_first_wedge_entropy_characteristic_continuation_planner.diagnostics.get(
    ...
    or euler_ambient_first_wedge_entropy_characteristic_continuation_audit is None
    or euler_ambient_first_wedge_entropy_characteristic_continuation_audit.status
    is not MocEulerAmbientFirstWedgeEntropyCharacteristicContinuationAuditStatus.CONVERGED_LOCAL_CONTINUATION_AUDIT
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.local_consistency_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.incoming_handoff_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.segment_links_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.reflection_anchor_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.alternating_seams_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.pressure_lineage_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.ambient_boundary_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.continuation_boundary_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.topology_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.cell_samples_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.cell_euler_residuals_finite
    or euler_ambient_first_wedge_entropy_characteristic_continuation_audit.cell_euler_residuals_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.status_consistent
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_audit.fidelity_flags_verified
  ...
  euler_ambient_first_wedge_entropy_characteristic_continuation_chain_failure = (
    euler_ambient_first_wedge_entropy_characteristic_continuation_chain is None
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain.resolved
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.continuation_count != 2
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.termination.reason
    is not MocChainTerminationReason.SOLVER_RETURNED_NO_NEXT_CELL
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.termination.physical_termination
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.physical_chain_cell_count != 0
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain.chain_promotion_blocked
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.production_claim_allowed
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.handoff_links_verified is not True
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain.source_links_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain.fresh_domains_verified
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.diagnostics.get(
    ...
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain.diagnostics.get(
      'open_band_promotion_policy'
    ) != 'never-create-moc-chain-cell'
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit is None
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.status
    is not MocEulerAmbientFirstWedgeEntropyCharacteristicContinuationChainAuditStatus
    .CONVERGED_LOCAL_CONTINUATION_CHAIN_AUDIT
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.local_sequence_verified
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.accepted_continuation_count != 2
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.step_count != 3
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.incoming_handoff_links_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.source_links_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.gradient_links_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.fresh_domains_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.step_records_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.termination_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.planner_resolved_consistent
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.physical_chain_cell_count != 0
    or euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.physical_closure_verified
  ...
  euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_failure = (
    ...
    or any(
      ...
      or not remesh.converged
      or not remesh.local_characteristic_remesh_verified
      or not remesh.characteristic_geometry_verified
      or not remesh.variable_entropy_compatibility_verified
      or not remesh.pressure_lineage_carried
      or not remesh.continuation_boundary_verified
      or not remesh.topology_verified
      or not remesh.topology.connected
      or not remesh.topology.forms_closed_zone
    ...
    or any(
      ...
      or not audit.converged
      or not audit.local_consistency_verified
      or not audit.structural_consistency_verified
      or not audit.source_continuation_gates_verified
      or not audit.topology_verified
      ...
      or audit.physical_closure_verified
      or not audit.chain_promotion_blocked
      or audit.production_claim_allowed
      for audit in (
        euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_audits
      )
    )
    or euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner
    is None
    or euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner.field_count
    != 1
    or euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner.continued_field_count
    != 0
    or euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner.termination.reason
    is not MocChainTerminationReason.OPEN_PHYSICAL_CLOSURE
    or euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner.termination.physical_termination
    or euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner.physical_chain_cell_count
    != 0
    or euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner.physical_closure_verified
    or not euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_planner.chain_promotion_blocked
  ...
  failures = [
    ...
    *([
      {
        'case': 'euler_ambient_shock_field_explicit_companion',
        'status': euler_explicit_companion_ambient_shock_field.status.value,
        'message': euler_explicit_companion_ambient_shock_field.message,
      }
    ] if euler_explicit_companion_ambient_shock_field_failure else []),
    *([
      {
        'case': 'euler_ambient_shock_field_explicit_companion_chain_mock',
        'status': (
          euler_explicit_companion_ambient_shock_field_chain_mock.termination.reason.value
        ),
        'message': (
          'explicit companion ambient shock-field chain mock did not '
          'preserve exact open-field handoffs and its non-physical stop'
        ),
      }
    ] if euler_explicit_companion_ambient_shock_field_chain_mock_failure else []),
    *([
      {
        'case': 'euler_post_shock_field_local_closed_topology',
        'status': euler_post_shock_field.status.value,
        'message': euler_post_shock_field.message,
      }
    ] if euler_post_shock_field_failure else []),
    *([
      {
        'case': 'euler_post_shock_field_chain_mock',
        'status': euler_post_shock_field_chain_mock.termination.reason.value,
        'message': (
          'local exact-Euler post-shock field chain mock did not preserve '
          'fresh domains, exact centerline handoffs, and its non-physical stop'
        ),
      }
    ...
    *([
      {
        'case': 'euler_ambient_physical_field_refinement',
        'status': euler_ambient_physical_field_refinement.status.value,
    ...
    *([
      {
        'case': 'euler_ambient_first_wedge_characteristic_field_audit',
        'status': (
          'missing'
          if euler_ambient_first_wedge_characteristic_field_audit is None
          else euler_ambient_first_wedge_characteristic_field_audit.status.value
        ),
        'message': (
          'the solver-owned first-wedge field retile did not preserve its '
          'independent raw-mesh, entropy, Euler, and chain-stop gates'
        ),
      }
    ...
    *([
      {
        'case': 'euler_ambient_first_wedge_entropy_characteristic_field',
        'status': (
          'missing'
          if euler_ambient_first_wedge_entropy_characteristic_field_audit is None
          else euler_ambient_first_wedge_entropy_characteristic_field_audit.status.value
        ),
        'message': (
          'the solver-owned internal entropy-characteristic field did not '
          'preserve independent topology, family compatibility, Euler, and '
          'chain-stop gates'
        ),
      }
    ] if euler_ambient_first_wedge_entropy_characteristic_field_failure else []),
    *([
      {
        'case': 'euler_ambient_first_wedge_entropy_characteristic_field_chain',
        'status': (
          'missing'
          if euler_ambient_first_wedge_entropy_characteristic_field_chain_audit is None
          else euler_ambient_first_wedge_entropy_characteristic_field_chain_audit.status.value
        ),
        'message': (
          'the entropy-characteristic field-chain planner/audit did not '
          'preserve its exact frontier, nonphysical stop, and zero-cell gates'
        ),
      }
    ...
    *([
      {
        'case': 'euler_ambient_first_wedge_entropy_characteristic_free_boundary',
        'status': (
          'missing'
          if euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit is None
          else euler_ambient_first_wedge_entropy_characteristic_free_boundary_audit.status.value
        ),
        'message': (
          'the reflected/free-boundary entropy-characteristic probe did not '
          'preserve its bounded shock stop, exact handoff, independent audit, '
          'and non-promotion barrier'
        ),
      }
    ] if euler_ambient_first_wedge_entropy_characteristic_free_boundary_failure else []),
    *([
      {
        'case': 'euler_ambient_first_wedge_entropy_characteristic_continuation',
        'status': (
          'missing'
          if euler_ambient_first_wedge_entropy_characteristic_continuation_audit is None
          else euler_ambient_first_wedge_entropy_characteristic_continuation_audit.status.value
        ),
        'message': (
    ...
    *([
      {
        'case': 'euler_ambient_first_wedge_entropy_characteristic_continuation_chain',
        'status': (
          'missing'
          if euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit is None
          else euler_ambient_first_wedge_entropy_characteristic_continuation_chain_audit.status.value
        ),
        'message': (
          'the multi-band variable-entropy continuation chain did not preserve '
          'its exact frontiers, source lineage, fresh domains, independent '
          'audit, and non-promotion boundary'
        ),
      }
    ...
    *([
      {
        'case': 'euler_ambient_first_wedge_entropy_characteristic_continuation_remesh',
        'status': (
          'missing'
          if not euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_audits
          else euler_ambient_first_wedge_entropy_characteristic_continuation_remesh_audits[-1].status.value
        ),
        'message': (
          'the solver-owned characteristic-edge remesh did not preserve '
          'its independent edge, topology, Euler, and non-promotion gates'
        ),
      }
    ...
    *([
      {
        'case': 'euler_consistent_companion_characteristic_strip',
        'status': euler_companion_field.status.value,
        'message': euler_companion_field.message,
      }
    ] if (
      euler_companion_field.status is not MocEulerCompanionFieldStatus.CONVERGED_OPEN_COMPANION_FIELD
      or not euler_companion_field.converged
      or not euler_companion_field.state_sampling_available
      or not euler_companion_field.topology.connected
      or not euler_companion_field.topology.forms_closed_zone
      or not euler_companion_field.shock_boundary_local_euler_verified
      or not euler_companion_field.companion_boundary_contract_verified
    ...
    *([
      {
        'case': 'solver_generated_geometry_owned_first_cell_research_chain_refinement',
        'status': str(
          ((ambient_shock_strip_probe.get(
            'geometry_owned_first_cell_research_chain_refinement',
            {},
    ...
    ] if geometry_owned_first_cell_research_chain_refinement_failure else []),
    *([
      {
        'case': 'solver_generated_geometry_owned_first_cell_alternating_research_chain',
        'status': str(
          ((ambient_shock_strip_probe.get(
            'geometry_owned_first_cell_alternating_research_chain',
            {},
    ...
    ] if geometry_owned_first_cell_alternating_research_chain_failure else []),
    *([
      {
        'case': 'solver_generated_geometry_owned_first_cell_alternating_research_chain_refinement',
        'status': str(
          ((ambient_shock_strip_probe.get(
            'geometry_owned_first_cell_alternating_research_chain_refinement',
            {},
    ...
    ] if geometry_owned_first_cell_alternating_research_chain_refinement_failure else []),
    *([
      {
    ...
    *([
      {
        'case': 'solver_generated_reflected_domain_alternating_physical_field',
        'status': str(
          reflected_domain_remesh_probe.get(
            'solver_generated_alternating_physical_field',
            {},
        ...
        'message': str(
          reflected_domain_remesh_probe.get('alternating_physical_field_error')
          or reflected_domain_remesh_probe.get(
            'solver_generated_alternating_physical_field',
            {},
          ).get('message', '')
          if isinstance(reflected_domain_remesh_probe, dict)
          else 'alternating physical field probe missing'
        ),
      }
    ...
    *([
      {
        ...
        'message': str(
          ...
          if isinstance(reflected_domain_remesh_probe, dict)
          else 'alternating physical-field chain refinement probe missing'
        ),
      }
    ] if reflected_domain_alternating_physical_field_chain_refinement_failure else []),
    *([
      {
    ...
    *([
      {
        'case': 'mixed_regime_variable_entropy_free_boundary',
        'status': str(
          mixed_regime_variable_entropy_reference.get('status', 'missing')
          if isinstance(mixed_regime_variable_entropy_reference, dict)
          else 'missing'
        ),
        'message': str(
          mixed_regime_variable_entropy_reference.get('message', '')
          if isinstance(mixed_regime_variable_entropy_reference, dict)
          else ''
        ),
      }
    ] if mixed_regime_variable_entropy_reference_failure else []),
    *([
      {
